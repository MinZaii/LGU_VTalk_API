package kr.co.softbridge.voplatform.config;
...
@MapperScan(value = "kr.co.softbridge.voplatform", sqlSessionFactoryRef = "primarySqlSessionFactory", annotationClass = PrimaryMapper.class)
@Configuration
